...
Define_Module(AttackTestApp);

AttackTestApp::AttackTestApp()
{
}

bool AttackTestApp::startApplication()
{
...
bool AttackTestApp::stopApplication()
{
    return true;
}
...
void AttackTestApp::processPacket(std::shared_ptr<inet::Packet> pk)
{
